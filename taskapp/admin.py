...
admin.site.register(Detail_attendence)
...
admin.site.site_header = "VisionTrek Admin Portal"
admin.site.site_title = "VisionTrek Admin Portal"
admin.site.index_title = "VisionTrek Admin Portal"
